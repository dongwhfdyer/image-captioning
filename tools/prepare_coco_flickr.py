...
class COCOCaption:
    ...
    def prepare(self, split):
        ...
        print(f"Saved {self.dataset_name} {split} split to {self.save_path}...")
...
if __name__ == '__main__':
    ...
    # python tools/prepare_coco_flickr.py --annot-path annotations/dataset_coco.json --dataset-path data/coco2014 --save-path output/coco2014
    # python tools/prepare_coco_flickr.py --annot-path annotations/dataset_flickr30k.json --dataset-path data --save-path output/Flickr30k
    # python tools/prepare_coco_flickr.py --annot-path annotations/dataset_flickr30k.json --dataset-path data/flickr30k-images --save-path output/Flickr30k
